...
namespace MessagePack.Internal
{
    ...
    public static class CodeGenHelpers
    {
        ...
        public static ReadOnlySpan<byte> ReadStringSpan(ref MessagePackReader reader)
        {
            ...
            {
                return GetSpanFromNullableSequence(reader.ReadStringSequence());
            }
        ...
        private static ReadOnlySpan<byte> GetSpanFromNullableSequence(ReadOnlySequence<byte>? sequence)
        {
            return sequence.HasValue ? sequence.Value.ToArray() : default;
        }
    }
}
