...
namespace ET.Client
{
    ...
    /// Desc
    /// </summary>
    [FriendOf(typeof(AchievementsViewComponent))]
    [FriendOf(typeof(MissionItemComponent))]
    public static partial class AchievementsViewComponentSystem
    {
        [EntitySystem]
        private static void YIUIInitialize(this AchievementsViewComponent self)
        {
        ...
        [EntitySystem]
        private static void Destroy(this AchievementsViewComponent self)
        {
        }

        [EntitySystem]
        private static async ETTask<bool> YIUIOpen(this AchievementsViewComponent self)
        {
        ...
        [EntitySystem]
        private static void YIUILoopRenderer(this AchievementsViewComponent self, MissionItemComponent item, int data, 
