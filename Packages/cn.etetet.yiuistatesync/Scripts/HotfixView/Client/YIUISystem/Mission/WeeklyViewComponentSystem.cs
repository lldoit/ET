...
namespace ET.Client
{
    ...
    /// Desc
    /// </summary>
    [FriendOf(typeof(WeeklyViewComponent))]
    [FriendOf(typeof(MissionItemComponent))]
    public static partial class WeeklyViewComponentSystem
    {
        [EntitySystem]
        private static void YIUIInitialize(this WeeklyViewComponent self)
        {
        ...
        [EntitySystem]
        private static void Destroy(this WeeklyViewComponent self)
        {
        }

        [EntitySystem]
        private static async ETTask<bool> YIUIOpen(this WeeklyViewComponent self)
        {
        ...
        [EntitySystem]
        private static void YIUILoopRenderer(this WeeklyViewComponent self, MissionItemComponent item, int data, 
