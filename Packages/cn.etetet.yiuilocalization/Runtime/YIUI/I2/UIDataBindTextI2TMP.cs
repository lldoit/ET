...
namespace YIUIFramework
{
    ...
    [LabelText("Text 文本多语言TMP")]
    [AddComponentMenu("YIUIBind/Data/文本多语言TMP 【TextI2TMP】 UIDataBindTextI2TMP")]
    public sealed class UIDataBindTextI2TMP : UIDataBindTextI2Base
    {
        [SerializeField]
        [ReadOnly]
        [Required("必须有此组件")]
