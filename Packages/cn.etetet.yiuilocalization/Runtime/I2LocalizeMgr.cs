...
namespace I2.Loc
{
    ...
    public class I2LocalizeMgr : YIUIMonoSingleton<I2LocalizeMgr>, IResourceManager_Bundles
    {
        ...
        {
            var assetObject = ET.EventSystem.Instance?.YIUIInvokeEntitySyncSafety<YIUIInvokeEntity_Load, Object>(Entity, new YIUIInvokeEntity_Load
            {
                LoadType = assetType,
                ResName  = path
            });
        ...
        public async ETTask LoadLanguage(string language, bool setCurrent = false)
        {
            ...
            var loadResult = await ET.EventSystem.Instance?.YIUIInvokeEntityAsyncSafety<YIUIInvokeEntity_Load, ETTask<Object>>(Entity, new YIUIInvokeEntity_Load
            {
        ...
        public bool SetLanguage(string language, bool load = false)
        {
            ...
            ET.EventSystem.Instance?.YIUIInvokeEntitySyncSafety(Entity, new EventView_ChangeLanguage
            {
                Language = language
            });
            return true;
