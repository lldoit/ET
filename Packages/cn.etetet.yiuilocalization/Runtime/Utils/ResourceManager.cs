...
namespace I2.Loc
{
    ...
    public class ResourceManager : MonoBehaviour
    {
        ...
        public static ResourceManager pInstance
        {
            get
            {
                ...
                if (mInstance == null)
                    mInstance = FindAnyObjectByType<ResourceManager>();
	...
	public void OnLevelWasLoaded()
        ...
        public void CleanResourceCache(bool unloadResources = false)
        {
            ...
            {
                ET.EventSystem.Instance?.YIUIInvokeEntitySyncSafety(YIUISingletonHelper.YIUIMgr, new YIUIInvokeEntity_Release
                {
                    obj = obj
                });
            }
