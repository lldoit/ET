...
namespace I2.Loc
{
	...
	public static partial class GoogleTranslation
	{
		...
		{
			return LocalizationManager.Sources.Count > 0 && BaiduTranslationSettings.HasCredentials();
		}
        ...
        public static void Translate( string text, string LanguageCodeFrom, string LanguageCodeTo, fnOnTranslated OnTranslationReady )
		{
            ...
            if (!CanTranslate())
            {
                OnTranslationReady(null, "Baidu translate App ID or Secret Key is not configured");
                return;
            }
