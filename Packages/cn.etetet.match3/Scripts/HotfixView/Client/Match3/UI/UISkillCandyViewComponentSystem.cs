...
namespace ET.Client
{
    ...
    /// UI技能糖果视图组件系统
    /// </summary>
    [FriendOf(typeof(UISkillCandyViewComponent))]
    [EntitySystemOf(typeof(UISkillCandyViewComponent))]
    public static partial class UISkillCandyViewComponentSystem
    {
        [EntitySystem]
        private static void Awake(this UISkillCandyViewComponent self, RectTransform rectTransform)
        {
        ...
        [EntitySystem]
        private static void Destroy(this UISkillCandyViewComponent self)
        {
        ...
        /// 播放消除动画
        /// </summary>
        public static void PlayExplodeAnimation(this UISkillCandyViewComponent self)
        {
        ...
        /// 设置Sprite
        /// </summary>
        public static void SetSprite(this UISkillCandyViewComponent self, Sprite sprite)
        {
            if (self.Image != null)
            {
        ...
        /// 设置技能图标
        /// </summary>
        public static void SetSkillIcon(this UISkillCandyViewComponent self, Sprite iconSprite)
        {
        ...
        /// 重置视图状态
        /// </summary>
        public static void ResetView(this UISkillCandyViewComponent self)
        {
