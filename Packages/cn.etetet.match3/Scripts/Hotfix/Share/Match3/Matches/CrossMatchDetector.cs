...
{
    /// <summary>
    /// 十字架型匹配检测器（6个糖果，中心+2垂直+2水平，4种变体）
    /// </summary>
    [EnableClass]
    public class CrossMatchDetector : Object, IMatchDetector
    {
                    ...
                    if (tile != null)
                    {
                        ...
                        if (candy != null)
                        {
                            ...
                            if (j < height - 2)
                            {
                                ...
                                if (tileTop1 != null && tileBottom1 != null && tileBottom2 != null && tileLeft1 != null && tileRight1 != null)
                                {
                            ...
                            if (j >= 2)
                            {
                                ...
                                if (tileTop1 != null && tileTop2 != null && tileBottom1 != null && tileLeft1 != null && tileRight1 != null)
                                {
                                    var candyTop1 = tileTop1.GetComponent<CandyComponent>();
                            ...
                            if (i >= 2)
                            {
                                ...
                                if (tileTop1 != null && tileBottom1 != null && tileLeft1 != null && tileLeft2 != null && tileRight1 != null)
                                {
                                    var candyTop1 = tileTop1.GetComponent<CandyComponent>();
                                    var candyBottom1 = tileBottom1.GetComponent<CandyComponent>();
                                    var candyLeft1 = tileLeft1.GetComponent<CandyComponent>();
                            ...
                            if (i < width - 2)
                            {
                                ...
                                if (tileTop1 != null && tileBottom1 != null && tileLeft1 != null && tileRight1 != null && tileRight2 != null)
                                {
                                    var candyTop1 = tileTop1.GetComponent<CandyComponent>();
                                    var candyBottom1 = tileBottom1.GetComponent<CandyComponent>();
                                    var candyLeft1 = tileLeft1.GetComponent<CandyComponent>();
